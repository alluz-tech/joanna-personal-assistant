...
TOOLS = [
    ...
    {"type": "function", "name": "create_event", "description": "Cria um evento quando título, início e fim estiverem claros.", "parameters": {"type": "object", "properties": {"title": {"type": "string"}, "start_datetime": {"type": "string"}, "end_datetime": {"type": "string"}, "description": {"type": "string"}, "location": {"type": "string"}}, "required": ["title", "start_datetime", "end_datetime"], "additionalProperties": False}},
    {"type": "function", "name": "update_event", "description": "Atualiza um evento identificado por id.", "parameters": {"type": "object", "properties": {"event_id": {"type": "string"}, "title": {"type": "string"}, "start_datetime": {"type": "string"}, "end_datetime": {"type": "string"}, "description": {"type": "string"}, "location": {"type": "string"}}, "required": ["event_id"], "additionalProperties": False}},
